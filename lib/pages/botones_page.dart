            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [
                  ...
                  Color.fromRGBO(255, 142, 172, 1.0)
                ]
              )
            )
          )
    ...
    return SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text("Transiciones Clasicas", style: TextStyle(color: Colors.white,fontSize: 30.0, fontWeight: FontWeight.bold)),
              SizedBox(height: 10.0),
              Text("Est id veniam occaecat aliqua nulla officia duis.", style: TextStyle(color: Colors.white,fontSize: 18.0),)
            ],
        ),
      ),
    );
      ...
      child: BottomNavigationBar(
        items: [
          BottomNavigationBarItem(
            icon: Icon(Icons.calendar_view_day, size: 30.0),
            title: Container()
          ),
          BottomNavigationBarItem(
  ...
  Widget _botonesRedondeados(){
    return Table(
      children: [
        ...
        TableRow(
          children: [
            _crearBotonRedondeado(Colors.blueAccent, Icons.movie_filter,'Pelicula'), 
            _crearBotonRedondeado(Colors.green, Icons.cloud_upload,'Nube')
          ]
        ),
        TableRow(
          children: [
